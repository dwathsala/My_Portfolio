...
const heroStyles = `
  ...
  /* Formal Geometric Ring Rotation */
  ...
  /* Professional tracking accent around image */
  .formal-tracking-ring {
    animation: formalRotate 8s linear infinite;
  }
  ...
  return (
    <>
      ...
      >
        ...
        {/* 2. Image Section — Frameless with Formal Orbit Tracking Border Animation */}
        <div className="relative order-2 md:order-2 flex-shrink-0 anim-image-wrapper z-10 p-3">
          {/* Formal Rotating Tracking Border Accent */}
          <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-slate-300/40 via-blue-500/20 to-transparent formal-tracking-ring pointer-events-none"></div>
          
          {/* Main Profile Wrapper */}
          <div className="w-64 h-64 sm:w-80 sm:h-80 lg:w-[480px] lg:h-[480px] rounded-full overflow-hidden relative z-10 bg-white">
            <img
              src="Me.png"
              alt="Dulari Dayananda"
              className="w-full h-full object-cover transition-transform duration-500 ease-out hover:scale-105 hover:contrast-[102%]"
            />
          </div>
        </div>
